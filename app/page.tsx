...
export default function Home() {
    ...
    const getBookingStatus = (booking: Booking) => {
        try {
            ...
            startTime.setHours(Number.parseInt(startHours, 10), Number.parseInt(startMinutes, 10))

            const endTime = new Date(bookingDate)
            const [endHours, endMinutes] = booking.endTime.split(":")
            endTime.setHours(Number.parseInt(endHours, 10), Number.parseInt(endMinutes, 10))
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <nav className="flex items-center space-x-4">
                            ...
                            <Link href="/subscription" className="flex items-center text-sky-600 hover:text-sky-800">
                        ...
                        <CardContent className=" ">
                            <div
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-bold">{format(new Date(), "EEEE, MMMM d, yyyy")}</h2>
                                        <p className="text-sky-100">
                                            {getTodayBookingsCount()} booking{getTodayBookingsCount() !== 1 ? "s" : ""} scheduled
                                            for today
                                        </p>
                                    </div>
                                </div>
                ...
                <Card className="border-none shadow-lg py-0">
                    <CardHeader className="pb-3 bg-gradient-to-r from-sky-50 to-indigo-50 rounded-t-lg pt-8">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                                <CardTitle className="text-sky-700 text-2xl">Room Bookings</CardTitle>
                                <CardDescription>Manage all your room reservations in one place</CardDescription>
                            </div>
                    ...
                    <CardContent>
                        <div className="mb-6">
                            <Tabs defaultValue="today" value={activeTab} onValueChange={setActiveTab}
                                  className="w-full">
                                <TabsList
                                    className="w-full bg-sky-50 p-1 rounded-xl grid grid-cols-2 md:grid-cols-4 gap-1">
                                    <TabsTrigger
                                        value="today"
                            ...
                            <>
                                {filteredBookings.length > 0 ? (
                                    ...
                                    <div className="text-center py-12 bg-sky-50 rounded-md border border-sky-100">
                                        ...
                                        <h3 className="text-lg font-medium text-sky-700">No bookings found</h3>
                                        <p className="text-sky-600 mt-1">
                                            {filter ? "Try adjusting your search or filters" : "Create your first booking to get started"}
                                        </p>
                                        {!filter && (
                                            <Button
