...
export function ClientContainer({ view }: IProps) {
  const { selectedDate, selectedRoomId, events } = useCalendar();
  ...
  const filteredEvents = useMemo(() => {
    return events.filter(event => {
      ...
      if (view === "year") {
        ...
        const isRoomMatch = selectedRoomId === "all" || event.room === selectedRoomId;
        return isInSelectedYear && isRoomMatch;
      }
      ...
      if (view === "month" || view === "agenda") {
        ...
        const isRoomMatch = selectedRoomId === "all" || event.room === selectedRoomId;
        return isInSelectedMonth && isRoomMatch;
      }
      ...
      if (view === "week") {
        ...
        const isRoomMatch = selectedRoomId === "all" || event.room === selectedRoomId;
        return isInSelectedWeek && isRoomMatch;
      }
      ...
      if (view === "day") {
        ...
        const isRoomMatch = selectedRoomId === "all" || event.room === selectedRoomId;
        return isInSelectedDay && isRoomMatch;
      }
    });
