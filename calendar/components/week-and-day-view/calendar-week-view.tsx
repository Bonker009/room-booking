                        ...
                        return (
                          <div key={hour} className={cn("relative", isDisabled && "bg-calendar-disabled-hour")} style={{ height: "96px" }}>
                            ...
                            <DroppableTimeBlock date={day} hour={hour} minute={0}>
                              <SlotClickTrigger startDate={day} startTime={{ hour, minute: 0 }}>
                                <div className="absolute inset-x-0 top-0 h-[24px] cursor-pointer transition-colors hover:bg-accent" />
                              </SlotClickTrigger>
                            </DroppableTimeBlock>

                            <DroppableTimeBlock date={day} hour={hour} minute={15}>
                              <SlotClickTrigger startDate={day} startTime={{ hour, minute: 15 }}>
                            ...
                            <DroppableTimeBlock date={day} hour={hour} minute={30}>
                              <SlotClickTrigger startDate={day} startTime={{ hour, minute: 30 }}>
                                <div className="absolute inset-x-0 top-[48px] h-[24px] cursor-pointer transition-colors hover:bg-accent" />
                              </SlotClickTrigger>
                            </DroppableTimeBlock>

                            <DroppableTimeBlock date={day} hour={hour} minute={45}>
                              <SlotClickTrigger startDate={day} startTime={{ hour, minute: 45 }}>
