...
import { SlotClickTrigger } from "@/calendar/components/slot-click-trigger";
    ...
    <div className="flex w-full items-stretch">
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="shrink-0">
          ...
          {/* Day header */}
          <div className="relative z-20 flex border-b bg-card">
        ...
        <ScrollArea className="h-[800px]" type="always">
          <div className="flex min-w-0">
            ...
            {/* Day grid */}
            <div className="relative min-w-[12rem] flex-1 border-l bg-card">
                  ...
                  return (
                    <div key={hour} className={cn("relative", isDisabled && "bg-calendar-disabled-hour")} style={{ height: "96px" }}>
                      ...
                      <DroppableTimeBlock date={selectedDate} hour={hour} minute={0}>
                        <SlotClickTrigger startDate={selectedDate} startTime={{ hour, minute: 0 }}>
                          <div className="absolute inset-x-0 top-0 h-[24px] cursor-pointer transition-colors hover:bg-accent" />
                        </SlotClickTrigger>
                      </DroppableTimeBlock>

                      <DroppableTimeBlock date={selectedDate} hour={hour} minute={15}>
                        <SlotClickTrigger startDate={selectedDate} startTime={{ hour, minute: 15 }}>
                      ...
                      <DroppableTimeBlock date={selectedDate} hour={hour} minute={30}>
                        <SlotClickTrigger startDate={selectedDate} startTime={{ hour, minute: 30 }}>
                          <div className="absolute inset-x-0 top-[48px] h-[24px] cursor-pointer transition-colors hover:bg-accent" />
                        </SlotClickTrigger>
                      </DroppableTimeBlock>

                      <DroppableTimeBlock date={selectedDate} hour={hour} minute={45}>
                        <SlotClickTrigger startDate={selectedDate} startTime={{ hour, minute: 45 }}>
      ...
      <aside className="hidden w-72 shrink-0 flex-col divide-y overflow-hidden border-l bg-card md:flex">
